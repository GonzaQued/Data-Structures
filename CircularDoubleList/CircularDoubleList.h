...
//implementación de la clase CircularDoubleList.
template<typename T>
...
private:
    ...
    public:
        //atributos para clase CircularDoubleList.
...
public:
    //constructor para clase CircularDoubleList.
    CircularDoubleList()
    ...
    //métodos para la clase CircularDoubleList.
